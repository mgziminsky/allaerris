...
impl ApiClient {
    ...
    pub fn misc(&self) -> apis::MiscApi<'_> {
        apis::MiscApi(self)
    }

    pub fn notifications(&self) -> apis::NotificationsApi<'_> {
        apis::NotificationsApi(self)
    }

    pub fn projects(&self) -> apis::ProjectsApi<'_> {
        apis::ProjectsApi(self)
    }

    pub fn tags(&self) -> apis::TagsApi<'_> {
        apis::TagsApi(self)
    }

    pub fn teams(&self) -> apis::TeamsApi<'_> {
        apis::TeamsApi(self)
    }

    pub fn threads(&self) -> apis::ThreadsApi<'_> {
        apis::ThreadsApi(self)
    }

    pub fn users(&self) -> apis::UsersApi<'_> {
        apis::UsersApi(self)
    }

    pub fn version_files(&self) -> apis::VersionFilesApi<'_> {
        apis::VersionFilesApi(self)
    }

    pub fn versions(&self) -> apis::VersionsApi<'_> {
...
static DEFAULT_SERVER: std::sync::LazyLock<reqwest::Url> =
    std::sync::LazyLock::new(|| reqwest::Url::parse("https://api.modrinth.com/v2").unwrap());
impl<'a> Builder<'a> {
