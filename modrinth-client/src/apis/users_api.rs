...
impl UsersApi<'_> {
    ...
    pub async fn change_user_icon(&self, params: &ChangeUserIconParams<'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                400 => ChangeUserIconError::Status400(serde_json::from_str(&local_var_content)?),
                404 => ChangeUserIconError::Status404,
                _ => ChangeUserIconError::Unknown(serde_json::from_str(&local_var_content)?),
            };
    ...
    pub async fn get_followed_projects(&self, params: &GetFollowedProjectsParams<'_,>) -> Result<Vec<models::Project>> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => GetFollowedProjectsError::Status401(serde_json::from_str(&local_var_content)?),
                404 => GetFollowedProjectsError::Status404,
                _ => GetFollowedProjectsError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
    ...
    pub async fn get_payout_history(&self, params: &GetPayoutHistoryParams<'_,>) -> Result<models::UserPayoutHistory> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => GetPayoutHistoryError::Status401(serde_json::from_str(&local_var_content)?),
                404 => GetPayoutHistoryError::Status404,
                _ => GetPayoutHistoryError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn get_user(&self, params: &GetUserParams<'_,>) -> Result<models::User> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => GetUserError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn get_user_from_auth(&self) -> Result<models::User> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => GetUserFromAuthError::Status401(serde_json::from_str(&local_var_content)?),
                _ => GetUserFromAuthError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn get_user_projects(&self, params: &GetUserProjectsParams<'_,>) -> Result<Vec<models::Project>> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => GetUserProjectsError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn get_users(&self, params: &GetUsersParams<'_,>) -> Result<Vec<models::User>> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                _ => GetUsersError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn modify_user(&self, params: &ModifyUserParams<'_,'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => ModifyUserError::Status401(serde_json::from_str(&local_var_content)?),
                404 => ModifyUserError::Status404,
                _ => ModifyUserError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
    ...
    pub async fn withdraw_payout(&self, params: &WithdrawPayoutParams<'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => WithdrawPayoutError::Status401(serde_json::from_str(&local_var_content)?),
                404 => WithdrawPayoutError::Status404,
                _ => WithdrawPayoutError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
