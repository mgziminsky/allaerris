...
impl<'c> VersionsApi<'c> {
    ...
    pub async fn add_files_to_version(&self, params: &AddFilesToVersionParams<'_,'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                401 => AddFilesToVersionError::Status401(serde_json::from_str(&local_var_content)?),
                404 => AddFilesToVersionError::Status404,
                _ => AddFilesToVersionError::Unknown(serde_json::from_str(&local_var_content)?),
            };
    ...
    pub async fn create_version(&self, params: &CreateVersionParams<'_,>) -> Result<models::Version> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                400 => CreateVersionError::Status400(serde_json::from_str(&local_var_content)?),
                401 => CreateVersionError::Status401(serde_json::from_str(&local_var_content)?),
                _ => CreateVersionError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
    ...
    pub async fn delete_version(&self, params: &DeleteVersionParams<'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => DeleteVersionError::Status401(serde_json::from_str(&local_var_content)?),
                404 => DeleteVersionError::Status404,
                _ => DeleteVersionError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
    ...
    pub async fn get_project_versions(&self, params: &GetProjectVersionsParams<'_,'_,'_,>) -> Result<Vec<models::Version>> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => GetProjectVersionsError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn get_version(&self, params: &GetVersionParams<'_,>) -> Result<models::Version> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => GetVersionError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn get_version_from_id_or_number(&self, params: &GetVersionFromIdOrNumberParams<'_,'_,>) -> Result<models::Version> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => GetVersionFromIdOrNumberError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn modify_version(&self, params: &ModifyVersionParams<'_,'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => ModifyVersionError::Status401(serde_json::from_str(&local_var_content)?),
                404 => ModifyVersionError::Status404,
                _ => ModifyVersionError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
    ...
    pub async fn schedule_version(&self, params: &ScheduleVersionParams<'_,'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                400 => ScheduleVersionError::Status400(serde_json::from_str(&local_var_content)?),
                401 => ScheduleVersionError::Status401(serde_json::from_str(&local_var_content)?),
                _ => ScheduleVersionError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
