...
impl TeamsApi<'_> {
    pub async fn add_team_member(&self, params: &AddTeamMemberParams<'_,'_,>) -> Result<()> {
        ...
        local_var_req_builder = local_var_req_builder.json(user_identifier);
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                401 => AddTeamMemberError::Status401(serde_json::from_str(&local_var_content)?),
                404 => AddTeamMemberError::Status404,
                _ => AddTeamMemberError::Unknown(serde_json::from_str(&local_var_content)?),
            };
    ...
    pub async fn delete_team_member(&self, params: &DeleteTeamMemberParams<'_,'_,>) -> Result<()> {
        // unwrap the parameters
        let DeleteTeamMemberParams { id, user, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => DeleteTeamMemberError::Status401(serde_json::from_str(&local_var_content)?),
                404 => DeleteTeamMemberError::Status404,
                _ => DeleteTeamMemberError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
    ...
    pub async fn get_project_team_members(&self, params: &GetProjectTeamMembersParams<'_,>) -> Result<Vec<models::TeamMember>> {
        // unwrap the parameters
        let GetProjectTeamMembersParams { mod_id, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => GetProjectTeamMembersError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
    ...
    pub async fn get_team_members(&self, params: &GetTeamMembersParams<'_,>) -> Result<Vec<models::TeamMember>> {
        // unwrap the parameters
        let GetTeamMembersParams { id, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                _ => GetTeamMembersError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn get_teams(&self, params: &GetTeamsParams<'_,>) -> Result<Vec<Vec<models::TeamMember>>> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                _ => GetTeamsError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn join_team(&self, params: &JoinTeamParams<'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => JoinTeamError::Status401(serde_json::from_str(&local_var_content)?),
                404 => JoinTeamError::Status404,
                _ => JoinTeamError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
    ...
    pub async fn modify_team_member(&self, params: &ModifyTeamMemberParams<'_,'_,'_,>) -> Result<()> {
        // unwrap the parameters
        let ModifyTeamMemberParams { id, user, modify_team_member_body, } = params;
        ...
        local_var_req_builder = local_var_req_builder.json(modify_team_member_body);
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => ModifyTeamMemberError::Status401(serde_json::from_str(&local_var_content)?),
                404 => ModifyTeamMemberError::Status404,
                _ => ModifyTeamMemberError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
    ...
    pub async fn transfer_team_ownership(&self, params: &TransferTeamOwnershipParams<'_,'_,>) -> Result<()> {
        // unwrap the parameters
        let TransferTeamOwnershipParams { id, user_identifier, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => TransferTeamOwnershipError::Status401(serde_json::from_str(&local_var_content)?),
                404 => TransferTeamOwnershipError::Status404,
                _ => TransferTeamOwnershipError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
