...
impl<'c> TeamsApi<'c> {
    pub async fn add_team_member(&self, params: &AddTeamMemberParams<'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<AddTeamMemberError>(&local_var_content).map(|e| Box::new(e) as _).ok();
    ...
    pub async fn delete_team_member(&self, params: &DeleteTeamMemberParams<'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<DeleteTeamMemberError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_project_team_members(&self, params: &GetProjectTeamMembersParams<'_,>) -> Result<Vec<models::TeamMember>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetProjectTeamMembersError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_team_members(&self, params: &GetTeamMembersParams<'_,>) -> Result<Vec<models::TeamMember>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetTeamMembersError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_teams(&self, params: &GetTeamsParams<'_,>) -> Result<Vec<Vec<models::TeamMember>>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetTeamsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn join_team(&self, params: &JoinTeamParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<JoinTeamError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn modify_team_member(&self, params: &ModifyTeamMemberParams<'_,'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<ModifyTeamMemberError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn transfer_team_ownership(&self, params: &TransferTeamOwnershipParams<'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<TransferTeamOwnershipError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
