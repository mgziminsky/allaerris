...
impl ThreadsApi<'_> {
    pub async fn delete_thread_message(&self, params: &DeleteThreadMessageParams<'_,>) -> Result<()> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            let error = match status.as_u16() {
                401 => DeleteThreadMessageError::Status401(serde_json::from_str(&content)?),
                404 => DeleteThreadMessageError::Status404,
                _ => DeleteThreadMessageError::Unknown(serde_json::from_str(&content)?),
            };
    ...
    pub async fn get_open_reports(&self, params: &GetOpenReportsParams<>) -> Result<Vec<models::Report>> {
        ...
        if let Some(ref param_value) = params.count {
            req_builder = req_builder.query(&[("count", &param_value)]);
        }
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                401 => GetOpenReportsError::Status401(serde_json::from_str(&content)?),
                404 => GetOpenReportsError::Status404,
                _ => GetOpenReportsError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    pub async fn get_report(&self, params: &GetReportParams<'_,>) -> Result<models::Report> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                401 => GetReportError::Status401(serde_json::from_str(&content)?),
                404 => GetReportError::Status404,
                _ => GetReportError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    pub async fn get_reports(&self, params: &GetReportsParams<'_,>) -> Result<Vec<models::Report>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                401 => GetReportsError::Status401(serde_json::from_str(&content)?),
                404 => GetReportsError::Status404,
                _ => GetReportsError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    pub async fn get_thread(&self, params: &GetThreadParams<'_,>) -> Result<models::Thread> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            let error = match status.as_u16() {
                ...
                _ => GetThreadError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    pub async fn get_threads(&self, params: &GetThreadsParams<'_,>) -> Result<Vec<models::Thread>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            let error = match status.as_u16() {
                ...
                _ => GetThreadsError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    pub async fn modify_report(&self, params: &ModifyReportParams<'_,'_,>) -> Result<()> {
        ...
        req_builder = req_builder.json(&params.modify_report_request);
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                400 => ModifyReportError::Status400(serde_json::from_str(&content)?),
                401 => ModifyReportError::Status401(serde_json::from_str(&content)?),
                404 => ModifyReportError::Status404,
                _ => ModifyReportError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    pub async fn send_thread_message(&self, params: &SendThreadMessageParams<'_,'_,>) -> Result<models::Thread> {
        ...
        req_builder = req_builder.json(&params.thread_message_body);
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                400 => SendThreadMessageError::Status400(serde_json::from_str(&content)?),
                404 => SendThreadMessageError::Status404,
                _ => SendThreadMessageError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    ...
    pub async fn submit_report(&self, params: &SubmitReportParams<'_,>) -> Result<models::Report> {
        ...
        req_builder = req_builder.json(&params.creatable_report);
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                400 => SubmitReportError::Status400(serde_json::from_str(&content)?),
                401 => SubmitReportError::Status401(serde_json::from_str(&content)?),
                _ => SubmitReportError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
