...
#[derive(Clone, Debug)]
pub struct GetLatestVersionsFromHashesParams<'l1,> {
    /// Parameters of the updated version requested
    pub get_latest_versions_from_hashes_body: Option<&'l1 GetLatestVersionsFromHashesBody>,
}
...
impl<'c> VersionFilesApi<'c> {
    pub async fn delete_file_from_hash(&self, params: &DeleteFileFromHashParams<'_,'_,'_,>) -> Result<()> {
        ...
        if let Some(ref version_id) = version_id {
            local_var_req_builder = local_var_req_builder.query(&[("version_id", version_id)]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<DeleteFileFromHashError>(&local_var_content).map(|e| Box::new(e) as _).ok();
    ...
    pub async fn get_latest_version_from_hash(&self, params: &GetLatestVersionFromHashParams<'_,'_,'_,>) -> Result<models::Version> {
        // unwrap the parameters
        let GetLatestVersionFromHashParams { hash, algorithm, get_latest_version_from_hash_body, } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetLatestVersionFromHashError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_latest_versions_from_hashes(&self, params: &GetLatestVersionsFromHashesParams<'_,>) -> Result<std::collections::HashMap<String, models::Version>> {
        // unwrap the parameters
        let GetLatestVersionsFromHashesParams { get_latest_versions_from_hashes_body, } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetLatestVersionsFromHashesError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn version_from_hash(&self, params: &VersionFromHashParams<'_,'_,>) -> Result<models::Version> {
        // unwrap the parameters
        let VersionFromHashParams { hash, algorithm, multiple, } = params;
        ...
        if let Some(ref multiple) = multiple {
            local_var_req_builder = local_var_req_builder.query(&[("multiple", multiple)]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<VersionFromHashError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn versions_from_hashes(&self, params: &VersionsFromHashesParams<'_,>) -> Result<std::collections::HashMap<String, models::Version>> {
        // unwrap the parameters
        let VersionsFromHashesParams { hash_list, } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<VersionsFromHashesError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
