    ...
    pub async fn delete_file_from_hash(&self, params: &DeleteFileFromHashParams<'_,'_,'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                401 => DeleteFileFromHashError::Status401(serde_json::from_str(&local_var_content)?),
                404 => DeleteFileFromHashError::Status404,
                _ => DeleteFileFromHashError::Unknown(serde_json::from_str(&local_var_content)?),
            };
    ...
    pub async fn get_latest_version_from_hash(&self, params: &GetLatestVersionFromHashParams<'_,'_,'_,>) -> Result<models::Version> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => GetLatestVersionFromHashError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
    ...
    pub async fn get_latest_versions_from_hashes(&self, params: &GetLatestVersionsFromHashesParams<'_,'_>) -> Result<std::collections::HashMap<String, models::Version>> {  // MANUAL: Additional lifetime
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => GetLatestVersionsFromHashesError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn version_from_hash(&self, params: &VersionFromHashParams<'_,'_,>) -> Result<models::Version> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => VersionFromHashError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn versions_from_hashes(&self, params: &VersionsFromHashesParams<'_,>) -> Result<std::collections::HashMap<String, models::Version>> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                ...
                _ => VersionsFromHashesError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
