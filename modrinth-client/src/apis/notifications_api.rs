...
impl<'c> NotificationsApi<'c> {
    pub async fn delete_notification(&self, params: &DeleteNotificationParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<DeleteNotificationError>(&local_var_content).map(|e| Box::new(e) as _).ok();
    ...
    pub async fn delete_notifications(&self, params: &DeleteNotificationsParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<DeleteNotificationsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_notification(&self, params: &GetNotificationParams<'_,>) -> Result<models::Notification> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetNotificationError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_notifications(&self, params: &GetNotificationsParams<'_,>) -> Result<Vec<models::Notification>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetNotificationsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_user_notifications(&self, params: &GetUserNotificationsParams<'_,>) -> Result<Vec<models::Notification>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetUserNotificationsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn read_notification(&self, params: &ReadNotificationParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<ReadNotificationError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn read_notifications(&self, params: &ReadNotificationsParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<ReadNotificationsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
