...
impl NotificationsApi<'_> {
    pub async fn delete_notification(&self, params: &DeleteNotificationParams<'_,>) -> Result<()> {
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            ...
            let local_var_error = match local_var_status.as_u16() {
                401 => DeleteNotificationError::Status401(serde_json::from_str(&local_var_content)?),
                404 => DeleteNotificationError::Status404,
                _ => DeleteNotificationError::Unknown(serde_json::from_str(&local_var_content)?),
            };
    ...
    pub async fn delete_notifications(&self, params: &DeleteNotificationsParams<'_,>) -> Result<()> {
        // unwrap the parameters
        let DeleteNotificationsParams { ids, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => DeleteNotificationsError::Status401(serde_json::from_str(&local_var_content)?),
                404 => DeleteNotificationsError::Status404,
                _ => DeleteNotificationsError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
    ...
    pub async fn get_notification(&self, params: &GetNotificationParams<'_,>) -> Result<models::Notification> {
        // unwrap the parameters
        let GetNotificationParams { id, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => GetNotificationError::Status401(serde_json::from_str(&local_var_content)?),
                404 => GetNotificationError::Status404,
                _ => GetNotificationError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
    ...
    pub async fn get_notifications(&self, params: &GetNotificationsParams<'_,>) -> Result<Vec<models::Notification>> {
        // unwrap the parameters
        let GetNotificationsParams { ids, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => GetNotificationsError::Status401(serde_json::from_str(&local_var_content)?),
                404 => GetNotificationsError::Status404,
                _ => GetNotificationsError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn get_user_notifications(&self, params: &GetUserNotificationsParams<'_,>) -> Result<Vec<models::Notification>> {
        // unwrap the parameters
        let GetUserNotificationsParams { user, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => GetUserNotificationsError::Status401(serde_json::from_str(&local_var_content)?),
                404 => GetUserNotificationsError::Status404,
                _ => GetUserNotificationsError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            serde_json::from_str(&local_var_content).map_err(Into::into)
    ...
    pub async fn read_notification(&self, params: &ReadNotificationParams<'_,>) -> Result<()> {
        // unwrap the parameters
        let ReadNotificationParams { id, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => ReadNotificationError::Status401(serde_json::from_str(&local_var_content)?),
                404 => ReadNotificationError::Status404,
                _ => ReadNotificationError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
    ...
    pub async fn read_notifications(&self, params: &ReadNotificationsParams<'_,>) -> Result<()> {
        // unwrap the parameters
        let ReadNotificationsParams { ids, } = params;
        ...
        if local_var_status.is_client_error() || local_var_status.is_server_error() {
            #[allow(clippy::match_single_binding)]
            let local_var_error = match local_var_status.as_u16() {
                401 => ReadNotificationsError::Status401(serde_json::from_str(&local_var_content)?),
                404 => ReadNotificationsError::Status404,
                _ => ReadNotificationsError::Unknown(serde_json::from_str(&local_var_content)?),
            };
            Err(ErrorResponse { status: local_var_status, content: local_var_content, source: Some(local_var_error.into()) }.into())
        } else {
            Ok(())
