...
impl<'c> ProjectsApi<'c> {
    ...
    pub async fn add_gallery_image(&self, params: &AddGalleryImageParams<'_,'_,'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<AddGalleryImageError>(&local_var_content).map(|e| Box::new(e) as _).ok();
    ...
    pub async fn change_project_icon(&self, params: &ChangeProjectIconParams<'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<ChangeProjectIconError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn check_project_validity(&self, params: &CheckProjectValidityParams<'_,>) -> Result<models::ProjectIdentifier> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<CheckProjectValidityError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn create_project(&self, params: &CreateProjectParams<'_,>) -> Result<models::Project> {
        ...
        // FIXME: support file upload for 'icon' parameter
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<CreateProjectError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn delete_gallery_image(&self, params: &DeleteGalleryImageParams<'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<DeleteGalleryImageError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn delete_project(&self, params: &DeleteProjectParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<DeleteProjectError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn delete_project_icon(&self, params: &DeleteProjectIconParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<DeleteProjectIconError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn follow_project(&self, params: &FollowProjectParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<FollowProjectError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_dependencies(&self, params: &GetDependenciesParams<'_,>) -> Result<models::ProjectDependencyList> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetDependenciesError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_project(&self, params: &GetProjectParams<'_,>) -> Result<models::Project> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetProjectError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn get_projects(&self, params: &GetProjectsParams<'_,>) -> Result<Vec<models::Project>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<GetProjectsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn modify_gallery_image(&self, params: &ModifyGalleryImageParams<'_,'_,'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<ModifyGalleryImageError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn modify_project(&self, params: &ModifyProjectParams<'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<ModifyProjectError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn patch_projects(&self, params: &PatchProjectsParams<'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<PatchProjectsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn random_projects(&self, params: &RandomProjectsParams<>) -> Result<Vec<models::Project>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<RandomProjectsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn schedule_project(&self, params: &ScheduleProjectParams<'_,'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<ScheduleProjectError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn search_projects(&self, params: &SearchProjectsParams<'_,'_,'_,>) -> Result<models::SearchResults> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<SearchProjectsError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
    ...
    pub async fn unfollow_project(&self, params: &UnfollowProjectParams<'_,>) -> Result<()> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity = serde_json::from_str::<UnfollowProjectError>(&local_var_content).map(|e| Box::new(e) as _).ok();
            let local_var_error = ErrorResponse { status: local_var_status, content: local_var_content, source: local_var_entity };
            Err(local_var_error.into())
        }
    }
