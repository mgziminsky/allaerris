...
impl TagsApi<'_> {
    ...
    pub async fn category_list(&self) -> Result<Vec<models::CategoryTag>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            let error = match status.as_u16() {
                _ => CategoryListError::Unknown(serde_json::from_str(&content)?),
            };
    ...
    pub async fn donation_platform_list(&self) -> Result<Vec<models::DonationPlatformTag>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                _ => DonationPlatformListError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    ...
    pub async fn license_list(&self) -> Result<Vec<models::LicenseTag>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                _ => LicenseListError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    pub async fn license_text(&self, params: &LicenseTextParams<'_,>) -> Result<models::License> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                400 => LicenseTextError::Status400(serde_json::from_str(&content)?),
                _ => LicenseTextError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    ...
    pub async fn loader_list(&self) -> Result<Vec<models::LoaderTag>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                _ => LoaderListError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    ...
    pub async fn project_type_list(&self) -> Result<Vec<String>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                _ => ProjectTypeListError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    ...
    pub async fn report_type_list(&self) -> Result<Vec<String>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                _ => ReportTypeListError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    ...
    pub async fn side_type_list(&self) -> Result<Vec<String>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                _ => SideTypeListError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
    ...
    pub async fn version_list(&self) -> Result<Vec<models::GameVersionTag>> {
        ...
        if !status.is_client_error() && !status.is_server_error() {
            ...
            #[allow(clippy::match_single_binding)]
            let error = match status.as_u16() {
                _ => VersionListError::Unknown(serde_json::from_str(&content)?),
            };
            Err(ErrorResponse { status, content, source: Some(error.into()) }.into())
        }
    }
