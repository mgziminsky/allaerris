...
pub struct EditableVersion {
    ...
    #[serde(rename = "primary_file", default)]
    pub primary_file: Vec<String>,
    /// A list of file_types to edit
    #[serde(rename = "file_types", default)]
    pub file_types: Vec<models::EditableFileType>,
}

impl EditableVersion {
    #[allow(clippy::too_many_arguments)]
    pub fn new(name: String, version_number: String, dependencies: Vec<models::VersionDependency>, game_versions: Vec<String>, version_type: VersionType, loaders: Vec<String>, featured: bool, status: Status, primary_file: Vec<String>, file_types: Vec<models::EditableFileType>) -> Self {
        Self {
            name,
            version_number,
            dependencies,
