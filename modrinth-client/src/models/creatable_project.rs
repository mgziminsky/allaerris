...
pub struct CreatableProject {
    ...
    #[deprecated]
    #[serde(rename = "initial_versions", default)]
    pub initial_versions: Vec<models::EditableVersion>,
    ...
    #[deprecated]
    #[serde(rename = "gallery_items", default)]
    pub gallery_items: Vec<models::CreatableProjectGalleryItem>,
}

impl CreatableProject {
    #[allow(clippy::too_many_arguments)]
    pub fn new(slug: String, title: String, description: String, categories: Vec<String>, client_side: ClientSide, server_side: ServerSide, body: String, status: Status, additional_categories: Vec<String>, donation_urls: Vec<models::ProjectDonationUrl>, license_id: String, project_type: ProjectType, initial_versions: Vec<models::EditableVersion>, is_draft: bool, gallery_items: Vec<models::CreatableProjectGalleryItem>) -> Self {
        Self {
            slug,
            title,
            description,
