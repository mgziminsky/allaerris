...
pub struct CreatableVersion {
    ...
    #[serde(rename = "file_parts", default)]
...
impl CreatableVersion {
    ...
    pub fn new(name: String, version_number: String, dependencies: Vec<models::VersionDependency>, game_versions: Vec<String>, version_type: VersionType, loaders: Vec<String>, featured: bool, status: Status, project_id: String, file_parts: Vec<String>, primary_file: String) -> Self {
        Self {
            name,
            version_number,
            dependencies,
