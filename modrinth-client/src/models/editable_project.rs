...
pub struct EditableProject {
    ...
    #[serde(rename = "moderation_message", skip_serializing_if = "Option::is_none")]
    pub moderation_message: Option<String>,
    /// The body of the moderators' message for the project
    #[serde(rename = "moderation_message_body", skip_serializing_if = "Option::is_none")]
    pub moderation_message_body: Option<String>,
}

impl EditableProject {
    pub fn new(slug: String, title: String, description: String, categories: Vec<String>, client_side: ClientSide, server_side: ServerSide, body: String, status: Status, additional_categories: Vec<String>, donation_urls: Vec<models::ProjectDonationUrl>, license_id: String) -> Self {
        Self {
            slug,
            title,
            description,
