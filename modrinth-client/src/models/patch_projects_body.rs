...
pub struct PatchProjectsBody {
    ...
    #[serde(rename = "add_categories", default)]
    pub add_categories: Vec<String>,
    /// Remove all of the categories specified here
    #[serde(rename = "remove_categories", default)]
    ...
    #[serde(rename = "add_additional_categories", default)]
    pub add_additional_categories: Vec<String>,
    /// Remove all of the additional categories specified here
    #[serde(rename = "remove_additional_categories", default)]
    ...
    #[serde(rename = "add_donation_urls", default)]
    pub add_donation_urls: Vec<models::ProjectDonationUrl>,
    /// Remove all of the donation links specified here
    #[serde(rename = "remove_donation_urls", default)]
    pub remove_donation_urls: Vec<models::ProjectDonationUrl>,
...
impl PatchProjectsBody {
    ...
    pub fn new(categories: Vec<String>, add_categories: Vec<String>, remove_categories: Vec<String>, additional_categories: Vec<String>, add_additional_categories: Vec<String>, remove_additional_categories: Vec<String>, donation_urls: Vec<models::ProjectDonationUrl>, add_donation_urls: Vec<models::ProjectDonationUrl>, remove_donation_urls: Vec<models::ProjectDonationUrl>) -> Self {
        Self {
            categories,
            add_categories,
            remove_categories,
