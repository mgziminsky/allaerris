...
impl BaseVersion {
    pub fn new(name: String, version_number: String, dependencies: Vec<models::VersionDependency>, game_versions: Vec<String>, version_type: VersionType, loaders: Vec<String>, featured: bool, status: Status) -> Self {
        Self {
            name,
            version_number,
            dependencies,
