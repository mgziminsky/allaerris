...
pub struct ThreadMessageBody {
    ...
    #[serde(rename = "replying_to", skip_serializing_if = "Option::is_none")]
...
impl ThreadMessageBody {
    ...
    pub fn new(r#type: Type, body: String, private: bool, old_status: OldStatus, new_status: NewStatus) -> Self {
        Self {
            r#type,
            body,
            private,
