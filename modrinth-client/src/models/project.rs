...
pub struct Project {
    ...
    pub body_url: Option<url::Url>, // MANUAL CHANGE - url::Url
    #[deprecated]
    #[serde(rename = "moderator_message", skip_serializing_if = "Option::is_none")]
    pub moderator_message: Option<models::ModeratorMessage>,
    ...
    #[serde(rename = "gallery", default)]
    pub gallery: Vec<models::GalleryImage>,
}
