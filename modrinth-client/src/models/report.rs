...
impl Report {
    pub fn new(report_type: String, item_id: String, item_type: ItemType, body: String, id: String, reporter: String, created: String, closed: bool, thread_id: String) -> Self {
        Self {
            report_type,
            item_id,
            item_type,
