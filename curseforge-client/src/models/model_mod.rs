...
pub struct Mod {
    ...
    pub videos: Vec<models::ModAsset>,
    ...
    pub latest_files_indexes: Vec<models::FileIndex>,
    /// List of file related details for the latest early access files of the mod
    #[serde(rename = "latestEarlyAccessFilesIndexes", default)]
    pub latest_early_access_files_indexes: Vec<models::FileIndex>,
    ...
    /// Does the mod enable comments
    #[serde(rename = "hasCommentsEnabled", skip_serializing_if = "Option::is_none")]
    pub has_comments_enabled: Option<bool>,
    #[serde(rename = "ratingDetails")]
    pub rating_details: models::RatingDetails,
    #[serde(rename = "serverAffiliation")]
    pub server_affiliation: models::ServerAffiliation,
    /// The mod's social links
    #[serde(rename = "socialLinks", default)]
    pub social_links: Vec<models::SocialLink>,
}

impl Mod {
    #[allow(clippy::too_many_arguments)]
    pub fn new(id: u64, game_id: u32, name: String, slug: String, links: models::ModLinks, summary: String, status: models::ModStatus, download_count: u64, primary_category_id: u32, categories: Vec<models::Category>, authors: Vec<models::ModAuthor>, logo: models::ModAsset, screenshots: Vec<models::ModAsset>, videos: Vec<models::ModAsset>, main_file_id: u64, latest_files: Vec<models::File>, latest_files_indexes: Vec<models::FileIndex>, latest_early_access_files_indexes: Vec<models::FileIndex>, date_created: String, date_modified: String, date_released: String, game_popularity_rank: u32, is_available: bool, thumbs_up_count: u32, rating_details: models::RatingDetails, server_affiliation: models::ServerAffiliation, social_links: Vec<models::SocialLink>) -> Self {
        Self {
            id,
            game_id,
            name,
